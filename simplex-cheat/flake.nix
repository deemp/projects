    ...
    let
      ...
      packages = {
        ...
        default = justStaticExecutable {
          ...
          runtimeDependencies = packageRuntimeDependencies;
          description = "`Simplex Chat` - like app with a server and bots";
        };
        ...
        writeConfigs = (import nix-files/writers.nix {
          inherit pkgs system;
      ...
      devShells = {
        default = mkShell {
          ...
          commands =
            ...
            ++ mkRunCommands "project" { inherit (packages) writeConfigs; }
